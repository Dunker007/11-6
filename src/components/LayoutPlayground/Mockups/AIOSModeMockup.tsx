  ...
  return (
    <div className="ai-os-mockup">
      ...
      <div className="feature-labels">
        ...
        <div className="feature-label" style={{ bottom: '50%', left: '20px', transform: 'translateY(50%)' }}>
          <span className="label-tag">AI Agents Always On</span>
          <span className="label-arrow">→</span>
        </div>
        <div className="feature-label" style={{ bottom: '50%', right: '20px', transform: 'translateY(50%)' }}>
          <span className="label-tag">Vibed Ed: System Intelligence</span>
          <span className="label-arrow">←</span>
        </div>
      </div>
    </div>
