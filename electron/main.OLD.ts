...
// Disable auto-updater in dev - causes initialization errors
...
// Auto-updater configuration - DISABLED until production-ready
function setupAutoUpdater() {
  // DISABLED: Auto-updater completely disabled during development
  return;
  /*
  if (isDev) {
...
// IPC handler for manual update check - DISABLED
/*
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    },
    {
      ...
      submenu: [
        ...
        /* DISABLED: Auto-updater disabled
        {
          label: 'Check for Updates',
          click: async () => {
            // DISABLED: Auto-updater disabled during core development
            dialog.showMessageBox(win!, {
              type: 'info',
              title: 'Updates',
              message: 'Auto-updater is currently disabled during development.',
            });
          },
        },
        */
...
app.whenReady().then(() => {
  createMenu();
  createWindow();
  // setupAutoUpdater(); // DISABLED: Auto-updater disabled until app is production-ready
});
